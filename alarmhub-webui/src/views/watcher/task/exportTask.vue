<template>
  <el-dialog append-to-body :close-on-click-modal="false" :visible.sync="dialog" title="导出规则" width="550px">
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button :loading="crud.status.cu === 2" type="primary" @click="submit">确认</el-button>
    </div>
  </el-dialog>
</template>
